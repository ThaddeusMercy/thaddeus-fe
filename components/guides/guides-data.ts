...
},
{
  ...
  {
    slug: "5-github-repos-better-ai-websites",
    title: "5 GitHub repos to make your AI website look better",
    excerpt:
      "Five GitHub repos for 3D objects, Apple-style glass, cinematic scrolling, animated logos and moving backgrounds — with previews and copy-paste prompts.",
    category: "GUIDE",
    topic: "creative",
    ...
    sections: [
      {
        heading: "5 GitHub repos to make your AI website look better",
        body: "React Three Fiber, Liquid Glass JS, Scroll World, Liquid Logo and Shader Gradient — with demos and prompts to hand to your AI coding tool.",
      },
    ],
  },
  {
